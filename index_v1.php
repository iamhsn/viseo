    ...
    <body>
        <div class="container">
            ...
            <div class="header pure-u-1-1">
                ...
                <!-- <div> -->
                    <div class="massive_text_container" style="float:right;width:48.4vw; height:107vh;margin-top:10%;">
                        <img style="max-width:100%;" class="pure-img" src="./img_laptop.png">
                    </div>
                ...
                <!-- <div style="float:left;">
                        <button style="" class=""><a href="">About Us</a></button>
                </div> -->
